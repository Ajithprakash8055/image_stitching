...
from registration import get_image_paths 
...
for filename in os.listdir(folder_path):
    ...
    if filename.endswith(".jpg") or filename.endswith(".png"):
        ...
        if img is not None:
            ...
            parking_images.append(img)
        else:
            print(f"Failed to load image: {file_path}")

# Now 'images' contains all the images in the folder
print(f"Loaded {len(parking_images)} images.")



print(parking_images)
...
images=Images.of(parking_images)
